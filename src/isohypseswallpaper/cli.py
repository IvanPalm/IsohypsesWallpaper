...
def main():
    ...
    lat_min, lat_max, lon_min, lon_max = geometry.bounding_box(args.lat, args.lon, width_m, height_m)

    # Fetch DEM
    dem_array, dem_meta = srtm.get_dem(lat_min, lat_max, lon_min, lon_max, resolution=30)
